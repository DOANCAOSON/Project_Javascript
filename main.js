...
function handleProducts() {
    let ApiProducts = 'https://vithanhtu.herokuapp.com/carts1'
...
function updateCarts(event) {
    ...
    let cartPrice = cartElement.querySelector
    ('.item-price').innerText.replace('$', '')
...
function renderProducts(e) {
    ...
    let pageActive = document.querySelector('.container_page-content-btn.active_btn')
